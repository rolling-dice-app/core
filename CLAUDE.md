...
| ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Multi-half-caster effective level (paladin + ranger; or multi-third-caster EK + AT) | `rules/spell-slots.ts` `getSuggestedRegularSpellSlots` (the `floor(halfLevels / 2)` step) | Each class halved separately then summed: `floor(pal/2) + floor(ran/2)`. Aligns with D&D Beyond / Roll20 / Sage Advice convention. | Sum first then halve: `floor((pal + ran) / 2)`. PHB p.165 "half your levels (rounded down) in the paladin and ranger classes" is collectively readable. | Difference is at most 1 effective level for rare double-half-caster odd-odd combos. Generosity is consistent with the permissive philosophy; switching to the stricter reading later costs only a few lines. |
