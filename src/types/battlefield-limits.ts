...
export const BATTLEFIELD_LIMITS = {
  ...
  /** maxHp / baseMaxHp 下限（單位必有至少 1 HP）；currentHp / tempHp 下限為 0 */
  UNIT_HP_MIN: 1,
  /** maxHp / baseMaxHp / currentHp / tempHp 共用上限 */
  UNIT_HP_MAX: CHARACTER_INT_LIMITS.GENERAL_INT_MAX,
  /** baseAc / currentAc 上限（下限為 0） */
  UNIT_AC_MAX: CHARACTER_INT_LIMITS.SMALL_INT_MAX,
  /** speedValue 上限（呎，下限為 0） */
  UNIT_SPEED_VALUE_MAX: CHARACTER_INT_LIMITS.GENERAL_INT_MAX,
  /** initiativeBonus ±cap */
