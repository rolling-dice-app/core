...
export const BATTLEFIELD_LIMITS = {
  ...
  /** speed 快照上限（下限為 0）；不能用 SMALL — 角色快照 30 + speedBonus(≤99) 最高 129 */
  UNIT_SPEED_MAX: CHARACTER_INT_LIMITS.GENERAL_INT_MAX,
  /** speedAdjustment ±cap（比照 COMBAT_STATE_LIMITS.SPEED_ADJUSTMENT_ABS_MAX） */
  UNIT_SPEED_ADJUSTMENT_ABS_MAX: CHARACTER_INT_LIMITS.SMALL_INT_MAX,
  /** 攻擊快照 hitBonus ±cap */
  UNIT_ATTACK_HIT_BONUS_ABS_MAX: CHARACTER_INT_LIMITS.SMALL_INT_MAX,
  /** 技能加值快照單值 ±cap（key 數天然受 SKILL_KEYS 封頂，無需條目數上限） */
  UNIT_SKILL_BONUS_ABS_MAX: CHARACTER_INT_LIMITS.SMALL_INT_MAX,
  /** initiativeBonus ±cap */
