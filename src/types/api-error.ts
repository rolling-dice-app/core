...
export const API_ERROR_CODES = [
  ...
  'DM_SESSION_CONTAINER_NOT_FOUND',
  'DM_SESSION_LOG_NOT_FOUND',
  ...
  'MONSTER_TEMPLATE_LIMIT_REACHED',
  'DM_SESSION_CONTAINER_LIMIT_REACHED',
  'DM_SESSION_LOG_LIMIT_REACHED',
  ...
  'DM_SESSION_MEMBER_SHARE_ID_INVALID',
